...
It bothers me that there's no easy way to remove styles from a button element or properly add `onClick` to an `div`. This encourages developers to take shortcuts and hurts users navigating the web with keyboard and screen readers.
